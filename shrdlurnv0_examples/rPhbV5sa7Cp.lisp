...
(example
  ...
  (timeStamp 2018-06-22T14:40:57.245)
  (NBestInd 26)
...
(example
  (id session:rPhbV5sa7Cp)
  (context (date 2018 5 22) (graph NaiveKnowledgeGraph ((string [[1],[3],[1],[0],[0],[1],[0]]) (name b) (name c))))
  (timeStamp 2018-06-22T14:41:21.597)
  (NBestInd 0)
  (utterance "apagar laranja")
  (targetFormula (call wallToString (call context:removeTop (call context:getTopColor (number 3 COLOR)))))
...
(example
  ...
  (timeStamp 2018-06-22T15:01:31.681)
  (NBestInd 2)
...
(example
  (id session:rPhbV5sa7Cp)
  (context (date 2018 5 22) (graph NaiveKnowledgeGraph ((string [[2],[3],[1],[2],[2]]) (name b) (name c))))
  (timeStamp 2018-06-22T15:01:38.256)
  (NBestInd 24)
  (utterance "apagar laranja")
...
(example
  (id session:rPhbV5sa7Cp)
  (context (date 2018 5 22) (graph NaiveKnowledgeGraph ((string [[1],[0],[1],[1],[1]]) (name b) (name c))))
  (timeStamp 2018-06-22T15:01:45.188)
  (NBestInd 7)
...
(example
  ...
  (timeStamp 2018-06-22T15:01:48.216)
  (NBestInd 0)
  (utterance azul)
