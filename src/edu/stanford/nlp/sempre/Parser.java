...
public abstract class Parser {
  public static class Options {
    ...
    @Option(gloss = "Print all derivations")
    public boolean printAllDerivations = true;
  }
  ...
  public void addToEvaluation(ParserState state, Evaluation evaluation) {
    ...
    for (int i = 0; i < predDerivations.size(); i++) {    
      ...
      if (print && opts.printAllDerivations) { // So we do not print derivations durint explicit/active calulations (L.S.)
        LogInfo.logs(
