...
import edu.stanford.nlp.sempre.freebase.utils.WnExpander;
...
public final class Aligner {
  ...
  public static class Options {
    @Option(gloss = "Path to file with derivations") public String derivationPath = "lib/wordnet-derivations.txt";
